      ...
      <div className="flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8 min-h-[calc(100vh-80px)]">
        <div className="w-full max-w-md animate-fade-in-up">
          ...
          <div className="bg-white dark:bg-gray-800 rounded-3xl shadow-2xl p-8 md:p-10 border border-gray-100 dark:border-gray-700 relative overflow-hidden transition-all duration-300 hover:shadow-glow">
            ...
            <div className="grid grid-cols-3 gap-3 mb-8 relative z-10 animate-fade-in-up animation-delay-500">
              <button
                type="button"
              ...
              <button
                ...
                className={`flex flex-col items-center justify-center p-3 rounded-xl border-2 transition-all duration-300 ${selectedRole === 'admin'
                  ? 'border-red-500 bg-red-500/5 text-red-600 shadow-lg scale-105'
                  : 'border-gray-200 dark:border-gray-700 text-gray-500 hover:border-red-500/50 hover:bg-gray-50 dark:hover:bg-gray-800'
                  }`}
              >
                <div className={`p-2 rounded-full mb-2 ${selectedRole === 'admin' ? 'bg-red-500 text-white' : 'bg-gray-100 dark:bg-gray-700'}`}>
                  <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z" />
                  </svg>
                </div>
                <span className="font-bold text-xs">{t('auth.admin', 'Admin')}</span>
              </button>
            </div>

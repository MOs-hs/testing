...
const AdminLayout = ({ children }) => {
  ...
  const menuItems = [
    ...
    { path: '/admin/users', icon: FiUsers, label: t('admin.users') },
    { path: '/admin/providers', icon: FiBriefcase, label: t('admin.providers') },
    { path: '/admin/services', icon: FiPackage, label: t('admin.services') },
    { path: '/admin/categories', icon: FiTag, label: t('admin.categories') },
    { path: '/admin/requests', icon: FiFileText, label: t('admin.requests') },
    { path: '/admin/provider-requests', icon: FiBriefcase, label: 'Provider Requests' },
    { path: '/admin/reviews', icon: FiStar, label: 'Reviews' },
    { path: '/admin/payments', icon: FiCreditCard, label: t('admin.payments') },
    { path: '/admin/reports', icon: FiFileText, label: t('admin.reports') },
          ...
          <div className="h-full flex flex-col">
            ...
            <div className="p-4 border-t border-gray-200 dark:border-gray-700">
              <div className="mb-4 px-4 py-2">
                ...
                <p className="text-xs text-gray-500 dark:text-gray-400">{t('admin.systemAdmin')}</p>
              </div>
              <button
